...
const AddToCard = ({image}) => {
     return (
          ...
          <h2 className=" absolute bottom-3 left-3  bg-primary-yellow text-primary-blue text-xl font-extrabold p-2 flex justify-center bott uppercase leading-5 pt-3">-30% off</h2>
          </div>
          <h2 className="  font-bold text-lg mt-2 hover:underline duration-300">Tittle</h2>
          <p className=" rounded font-semibold flex items-center gap-4 justify-start"><s className="text-gray-600">$4000</s> <span className=" font-bold">$2000</span></p>
